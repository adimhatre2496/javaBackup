package com.example.Cascade.controller;

import com.example.Cascade.model.Person;
import com.example.Cascade.model.PersonResponse;
import com.example.Cascade.service.PersonAddressService;
...
public class PersonController {
    ...
    public ResponseEntity<Void> updatedPerson(@PathVariable Long id,@RequestBody Person person){
